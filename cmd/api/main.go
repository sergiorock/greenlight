...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "db-dsn", "postgres://greenlight:12111988@localhost/greenlight?sslmode=disable", "PostgreSQL DSN")
...
func openDB(cfg config) (*sql.DB, error) {
	...
	// Set the maximum number of open (in-use + idle) connections in the pool. Note that // passing a value less than or equal to 0 will mean there is no limit. db.SetMaxOpenConns(cfg.db.maxOpenConns)
